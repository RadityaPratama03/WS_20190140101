...
import ti.umy.assesment1.exceptions.NonexistentEntityException;
import ti.umy.assesment1.exceptions.PreexistingEntityException;
...
public class MahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ti.umy_assesment.1_jar_0.0.1-SNAPSHOTPU");
